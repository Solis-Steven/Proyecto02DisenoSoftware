...
const MicrosoftStudios = ({setGameSelected, changeModalVisible}) => {
    ...
    useEffect(() => {
        const gamesData = async() => {
          try {
            const url = `https://api.rawg.io/api/games?page_size=40&key=24ceba8caedf4f538bf69ccd25d1d011&publishers=microsoft-studios`;
